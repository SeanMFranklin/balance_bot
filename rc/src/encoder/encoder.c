...
int32_t rc_encoder_read_delta(uint8_t ch) {
    switch (ch) {
        case 0:
...
int64_t rc_encoder_read_count(uint8_t ch) {
    switch (ch) {
        case 0:
...
int16_t rc_encoder_write(uint8_t ch, int pos) {
    switch (ch) {
        case 0:
