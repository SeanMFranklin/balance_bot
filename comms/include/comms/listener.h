 ...
 * @return True if the header data was read successfully, false otherwise.
 */
 ...
 * @return True if the header data is valid, false otherwise.
 */
bool validate_header(const uint8_t* header_data);
 ...
 */
bool read_message(const uint8_t* header_data, uint8_t* msg_data_serialized, uint16_t message_len, char* topic_msg_data_checksum);
 ...
 * @return True if the message data is valid, false otherwise.
 */
bool validate_message(const uint8_t* header_data, const uint8_t* msg_data_serialized, uint16_t message_len, char topic_msg_data_checksum);
